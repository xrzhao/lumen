...
use crate::mlir::builder::block::*;
use crate::mlir::builder::ffi::{self, BlockRef, FunctionOpRef, Span, Type, ValueRef};
use crate::mlir::builder::value::*;
use crate::mlir::builder::ModuleBuilder;
use crate::Result;
...
impl Function {
    ...
    pub fn new_block_with_params(
        ...
        for (i, (p, pv)) in parameters.iter().enumerate() {
